	...
	<div class="elemsnr-container">
		...
		<div>
			...
			<div class="elemsnr-support-credits">
				...
				<p>
					<strong><?php echo esc_html__( 'Please rate us', 'search-replace-for-elementor' ); ?></strong>
					<a href="<?php echo esc_url( ELEMSNR_PLUGIN_WPORG_RATE ); ?>" target="_blank">
						<img src="<?php echo esc_url( ELEMSNR_PLUGIN_DIR_URL ); ?>assets/dist/img/rate.png" alt="Rate us @ WordPress.org" />
					</a>
				</p>
				<p>
